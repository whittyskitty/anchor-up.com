<?php
/**
 * Template Name: Single Anchor Up Website Registration
 * Template for displaying the Anchor Up Website Registration form
 */
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-24 md:py-32">
        <div class="container mx-auto px-4">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">Anchor Up Website Registration</h1>
            <p class="text-xl text-blue-100">Register for Connection Plus Website Services</p>
        </div>
    </div>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-8 bg-blue-50 rounded-lg p-6">
                ...
                <p class="text-gray-700 mb-4">
                    If you need assistance with registration or have questions, please contact us:
                </p>
                <ul class="list-disc list-inside text-gray-700 space-y-2">
                    ...
                    <li>Email: <a href="mailto:customercare@anchordistributors.com" class="text-blue-600 hover:text-blue-800">customercare@anchordistributors.com</a></li>
                </ul>
            </div>
        </div>
    </div>
